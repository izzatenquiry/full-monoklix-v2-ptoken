...
const Section: React.FC<{ title: string; children: React.ReactNode; icon?: React.ComponentType<{ className?: string }> }> = ({ title, children, icon: Icon }) => (
    <div className="py-10 border-b border-neutral-100 dark:border-neutral-800 last:border-b-0">
        <h3 className="text-2xl font-bold text-neutral-900 dark:text-white mb-6 flex items-center gap-4">
            {Icon && (
                <div className="p-2 bg-brand-start/10 rounded-xl">
                    <Icon className="w-6 h-6 text-brand-start flex-shrink-0" />
                </div>
            )}
            {title}
        </h3>
        <div className="space-y-5 text-neutral-600 dark:text-neutral-300 text-base leading-relaxed pl-1 sm:pl-14">{children}</div>
    </div>
);

const SubSection: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
    <div className="mt-8 bg-neutral-50 dark:bg-neutral-800/30 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800">
        <h4 className="text-lg font-bold text-neutral-800 dark:text-neutral-100 mb-3">{title}</h4>
        <div className="space-y-3 text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">{children}</div>
    </div>
);
...
const GetStartedView: React.FC<GetStartedViewProps> = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto pb-20">
            ...
            <div className="mb-12 bg-white dark:bg-neutral-900 p-8 rounded-3xl shadow-soft border border-neutral-100 dark:border-neutral-800">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">Video Tutorials</h2>
                ...
                <div className="relative group rounded-2xl overflow-hidden shadow-lg bg-black">
                    ...
                    <button 
                        onClick={prevSlide} 
                        className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md border border-white/20 text-white p-3 rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-white/20 hover:scale-110 focus:outline-none"
                    ...
                    <button 
                        onClick={nextSlide} 
                        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md border border-white/20 text-white p-3 rounded-full opacity-0 group-hover:opacity-100 transition-all hover:bg-white/20 hover:scale-110 focus:outline-none"
                ...
                <div className="mt-6 flex flex-col items-center">
                    <h3 className="text-lg font-bold text-neutral-800 dark:text-white mb-4">{slideshowVideos[currentSlide].title}</h3>
                    ...
                    <div className="flex justify-center gap-2">
                        {slideshowVideos.map((_, index) => (
                            <button 
                                ...
                                className={`h-2 rounded-full transition-all duration-300 ${currentSlide === index ? 'w-8 bg-brand-start' : 'w-2 bg-neutral-300 dark:bg-neutral-700 hover:bg-neutral-400'}`}
            ...
            <div className="bg-white dark:bg-neutral-900 p-8 sm:p-12 rounded-3xl shadow-soft border border-neutral-100 dark:border-neutral-800">

                <Section title="Gambaran Keseluruhan: Cara MONOklix Berfungsi" icon={InformationCircleIcon}>
                    <p className="text-lg">Sebelum anda bermula, penting untuk memahami dua bahagian perkhidmatan kami. Fikirkan platform kami seperti kereta berprestasi tinggi:</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                        <div className="bg-blue-50 dark:bg-blue-900/10 p-5 rounded-xl border border-blue-100 dark:border-blue-900/30">
                            <h5 className="font-bold text-brand-start mb-2">🚗 Platform MONOklix (Kereta)</h5>
                            <p className="text-sm">Akaun anda memberi anda akses kepada papan pemuka, alatan (seperti Suite Imej dan Video), dan garaj (Galeri anda). Anda berada di tempat duduk pemandu.</p>
                        </div>
                        <div className="bg-purple-50 dark:bg-purple-900/10 p-5 rounded-xl border border-purple-100 dark:border-purple-900/30">
                            ...
                            <p className="text-sm">Untuk membuat kereta bergerak (untuk menjana kandungan), anda memerlukan bahan api. Ini disediakan oleh enjin AI Google yang berkuasa, dan ia memerlukan **Token** untuk diakses.</p>
                        </div>
                    </div>
                ...
                <Section title="Bab 1: Akaun & Token" icon={KeyIcon}>
                    ...
                    <SubSection title="Token: Automatik Sepenuhnya!">
                        <p className="font-bold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 p-3 rounded-lg inline-block mb-2">Berita baik: Anda tidak perlu mendapatkan atau mengurus token anda sendiri.</p>
                ...
                <Section title="Bab 3: Suite Idea Kandungan AI" icon={LightbulbIcon}>
                    <p>Suite ini direka untuk membantu anda sumbang saran dan mencipta kandungan bertulis untuk keperluan pemasaran anda.</p>
                     <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <li className="bg-neutral-50 dark:bg-neutral-800/30 p-4 rounded-xl text-sm"><strong className="block text-brand-start mb-1">Staf MONOklix</strong> Satu pasukan ejen AI khusus. Pilih ejen (seperti Penyelidik Pasaran atau Penulis Iklan), berikan input anda, dan dapatkan output peringkat pakar untuk tugas-tugas tertentu.</li>
                        <li className="bg-neutral-50 dark:bg-neutral-800/30 p-4 rounded-xl text-sm"><strong className="block text-brand-start mb-1">Idea Kandungan</strong> Atasi kebuntuan kreatif dengan memasukkan topik. AI menggunakan Carian Google untuk mencari trend semasa dan menjana 5 idea kandungan segar dengan tajuk dan penerangan.</li>
                        <li className="bg-neutral-50 dark:bg-neutral-800/30 p-4 rounded-xl text-sm"><strong className="block text-brand-start mb-1">Teks Pemasaran</strong> Cipta teks pemasaran yang meyakinkan untuk iklan, media sosial, atau laman web. Hanya terangkan produk, sasaran audiens, dan nada yang dikehendaki.</li>
                        <li className="bg-neutral-50 dark:bg-neutral-800/30 p-4 rounded-xl text-sm"><strong className="block text-brand-start mb-1">Penjana Jalan Cerita</strong> Titik permulaan yang sempurna untuk iklan video. Muat naik imej produk, tulis penerangan ringkas, dan AI akan menjana konsep papan cerita 1 babak yang lengkap.</li>
                    </ul>
                </Section>
                ...
                <Section title="Bab 4: Suite Imej AI" icon={ImageIcon}>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 border border-green-200 dark:border-green-800 rounded-2xl bg-green-50/50 dark:bg-green-900/10">
                            <h5 className="font-bold text-green-700 dark:text-green-400 flex items-center gap-2 mb-3">
                        ...
                        <div className="p-6 border border-red-200 dark:border-red-800 rounded-2xl bg-red-50/50 dark:bg-red-900/10">
                            <h5 className="font-bold text-red-600 dark:text-red-400 flex items-center gap-2 mb-3">
                     ...
                     <SubSection title="Memahami Penapis Keselamatan">
                        <p>Semua penjanaan imej dan teks AI tertakluk kepada penapis keselamatan Google. Permintaan anda mungkin disekat jika ia mengandungi kandungan yang berkaitan dengan:</p>
                         <ul className="list-disc pl-5 space-y-1 font-medium text-neutral-800 dark:text-neutral-200 mt-2">
                ...
                <Section title="Bab 5: Suite Video & Suara AI" icon={VideoIcon}>
                    <p className="text-lg mb-4">Cipta video yang menakjubkan dan suara latar profesional dengan mudah.</p>
                    <div className="grid grid-cols-1 gap-6">
                        <SubSection title="Penjanaan Video">
                            ...
                            <p className="mt-2 text-xs font-semibold uppercase tracking-wider text-neutral-400">Terbaik Untuk: Klip media sosial pendek</p>
                        </SubSection>
                        <SubSection title="Papan Cerita Video">
                            ...
                            <p className="mt-2 text-xs font-semibold uppercase tracking-wider text-neutral-400">Terbaik Untuk: Iklan produk lengkap</p>
                        </SubSection>
                ...
                <Section title="Bab 6: Memahami Model AI" icon={RobotIcon}>
                    ...
                    <div className="space-y-4 mt-6">
                        <div className="border-l-4 border-brand-start pl-4">
                            <h5 className="font-bold text-neutral-800 dark:text-neutral-100">Gemini 2.5 Flash (Teks & Multimodal)</h5>
                            <p className="text-sm mt-1">Model kerja utama untuk penjanaan teks dan pemahaman imej. Dioptimumkan untuk kelajuan tanpa bajet 'berfikir'.</p>
                        </div>
                        <div className="border-l-4 border-purple-500 pl-4">
                            <h5 className="font-bold text-neutral-800 dark:text-neutral-100">Veo Models (Video)</h5>
                            <p className="text-sm mt-1">Model utama Google untuk video. Kami menggunakan versi standard (kualiti tertinggi) dan versi pantas (hasil cepat).</p>
                        </div>
                        <div className="border-l-4 border-pink-500 pl-4">
                            <h5 className="font-bold text-neutral-800 dark:text-neutral-100">Imagen V3 & 4 (Imej)</h5>
                            <p className="text-sm mt-1">Imagen V3 digunakan untuk penyuntingan/komposisi. Imagen 4 digunakan untuk penjanaan Teks-ke-Imej berkualiti tinggi.</p>
                        </div>
                    </div>
                ...
                <Section title="Bab 7: Prompt & Perpustakaan" icon={LibraryIcon}>
                    ...
                    <SubSection title="Cara Menggunakan Perpustakaan">
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-sm mt-2 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="col-span-1">
                            <SubSection title="Storan Tempatan">
                                <p className="text-xs">Data disimpan dalam penyemak imbas anda. Membersihkan cache akan memadamkan galeri anda. Kami tidak menyimpan kandungan anda di pelayan.</p>
                            </SubSection>
                        </div>
                    </div>
